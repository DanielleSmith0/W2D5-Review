...
//This test is wrong, because the return fxn casues it to only loop once. It only checks the first items. Put return false outside the forloop, that way it doesn't occur, untill it finishes looping.
...
//  that takes in three parameters: 'array',
//  'operator', and 'amount'.
...
let myArr = changeNums([1,2,3], "subtract", 10);
