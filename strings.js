...
//js how to replace substrings in an occurance.
// replaceAll()
...
console.log('my number " 2 "\'s named " '+ first + ' ' + last + ' ": and you don\'t " prhrase + "!");
